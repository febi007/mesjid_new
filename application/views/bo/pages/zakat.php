...
<!--********************************** MODAL FORM ******************************-->
<!--<div id="modal_forms" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">-->
...
<!--                <div class="row">-->
<!--                    <form id="form_input">-->
<!--                        <input type="hidden" name="id_zakat" class="form-control id_zakat">-->
...
<!--                        <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">-->
<!--                            <div class="form-group">-->
<!--                                <label for="field-2" class="control-label">Jenis Zakat</label>-->
<!--                                <select name="jenis_zakat" class="form-control jenis_zakat">-->
<!--                                    <option value="">Pilih Jenis</option>-->
<!--                                    <option value="Fitrah">Fitrah</option>-->
<!--                                    <option value="Mall">Maal</option>-->
...
<!--                        <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">-->
<!--                            <div class="form-group">-->
<!--                                <label for="field-2" class="control-label">Bentuk Zakat</label>-->
<!--                                <select name="bentuk_zakat" class="form-control bentuk_zakat">-->
<!--                                    <option value="Default">Pilih Bentuk Zakat</option>-->
...
<!--                        </div>-->
<!---->
<!--                        <div class="col-md-3 col-lg-3 col-sm-3 col-xs-6 displayNone" id="HargaBeras">-->
<!--                            <div class="form-group">-->
<!--                                <label>Harga Beras</label>-->
<!--                                <input type="text" name="harga_beras" class="form-control harga_beras" id="harga_beras" onkeyup="isMoney('harga_beras', '+');">-->
<!--                            </div>-->
<!--                        </div>-->
<!--                        <div class="col-md-3 col-lg-3 col-sm-3 col-xs-6 displayNone" id="JumlahJiwa">-->
<!--                            <div class="form-group">-->
<!--                                <label>Jumlah Jiwa</label>-->
<!--                                <input type="number" name="jumlah_jiwa" class="form-control jumlah_jiwa">-->
<!--                            </div>-->
<!--                        </div>-->
<!--                        <div class="col-md-3 col-lg-3 col-sm-3 col-xs-6 displayNone" id="Persentase">-->
<!--                            <div class="form-group">-->
<!--                                <label id="separator">Persen</label>-->
<!--                                <input type="text" name="sparator" class="form-control sparator" value="2.5" readonly="">-->
<!--                            </div>-->
<!--                        </div>-->
<!--                        <div class="col-md-3 col-lg-3 col-sm-3 col-xs-6 displayNone" id="Total">-->
<!--                            <div class="form-group">-->
<!--                                <label id="paramTotal">Total</label>-->
<!--                                <input type="text" name="total_zakat" class="form-control total_zakat" id="total_zakat" onkeyup="isMoney('total_zakat', '+');">-->
<!--                            </div>-->
<!--                        </div>-->
<!--                        <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">-->
<!--                            <div class="form-group">-->
<!--                                <label for="field-2" class="control-label">Shodaqoh</label>-->
<!--                                <input type="text" name="shodaqoh" class="form-control shodaqoh" id="shodaqoh" onkeyup="isMoney('shodaqoh', '+');">-->
<!--                            </div>-->
<!--                        </div>-->
<!--                        <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">-->
<!--                            <div class="form-group">-->
			...
			<form id="form_input">
				<div class="modal-body">
					...
					<div class="row">
						...
						<input type="text" name="kd_zakat" class="form-control kd_zakat" id="kd_zakat">
